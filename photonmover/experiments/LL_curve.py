...
from instruments.Power_meters.Thorlabs import ThorlabsPowerMeter
from instruments.Power_Supplies.AgilentE3633A import AgilentE3633A
...
class LL_curve(Experiment):
    ...
    def perform_experiment(self, params, filename=None):
        ...
        for volt in voltage:
            ...
            pump_power = pump_power_tap*99  #scale to full power
    ...
    def required_params(self):
        ...
        """
        return ["pump_sensor", "VCSEL_sensor", "pump_wavelength", "VCSEL_wavelength", "voltage"]
...
if __name__ == '__main__':
    ...
    VCSEL_wavelength = 1264  #nm

    #OTHER DEVICE PARAMETERS
    device = 'devPolStable_noPol'
    tuning_voltage = 0  # [V]

    # EXPERIMENT PARAMETERS
    init_voltage = 4.2  # [V] Minimum transmission on VOA (Note: when set to 5V, AgilentE3633A momentarily exceeds current limit when turning output on)
    end_voltage = 1.6  # [V] Maximum transmission on VOA
    ...
    params = {"pump_sensor": PUMP_SENSOR, "VCSEL_sensor": VCSEL_SENSOR, "pump_wavelength": pump_wavelength, "VCSEL_wavelength": VCSEL_wavelength, "voltage": volt_list}
