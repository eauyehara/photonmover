...
#Qing's group spectrum analyzer
class HP8592B(MSA, Instrument):
    """
    ...
    def read_data(self, filename=None):
        ...
        #Get frequency start and stop values
        init_freq = self.gpib.query_ascii_values("FA?;")[0]
        end_freq = self.gpib.query_ascii_values("FB?;")[0]
...
if __name__ == '__main__':
    ...
    hp.read_data('QG_MSA_PDA20C_StokesON_chopper1kHz_RBW3kHz_ref-10dBm.csv')
    hp.close()
