...
class ThorlabsPowerMeter(Instrument, PowerMeter):
    ...
    def __init__(self):
        ...
        if sizeof(c_voidp) == 4:
            ...
            self.dll = cdll.LoadLibrary("C:\Program Files\IVI Foundation\VISA\Win64\Bin\TLPM_64.dll")  #Added for Portable Raman Laptop

        self.devSession = c_long()
        self.devSession.value = 0
        self.name = None  #EU added
    ...
    def initialize(self, deviceIndex = 0):

        print('Connecting to Thorlabs Power Meter #%d' % (deviceIndex+1))
        ...
        # for i in range(0, deviceCount.value):  #opens first found power meter but errors on additional power meters
        #     self.getRsrcName(c_int(i), resourceName)
        #     print(c_char_p(resourceName.raw).value)
        #     break

        #open device specified under device index (defaults to device 0 if deviceIndex not specified)
        self.getRsrcName(c_int(deviceIndex), resourceName)
        print(c_char_p(resourceName.raw).value)
    ...
    def init_function(self):
        self.setPowerAutoRange(c_int16(1))
        print('Thorlabs PM: Set Analog Output slope to 1000V/W')
        self.setAnalogOutputSlope(c_double(1000))
        print('Thorlabs PM: Setting input filter state to off for higher BW')
        self.setInputFilterState(c_int16(0))
    ...
    def set_wavelength(self, wavelength):
        ...
        print('Wavelength set to %d nm' % wavelength)
    ...
    def set_range(self, channel, range):
        ...
        # setPowerRange takes W, so convert from dBm to W
        range_W = 10**(range/10)*1e-3
        self.setPowerRange(c_double(range_W))
    ...
    def setCurrentAutoRange(self, currentAutorangeMode):
        ...
        Args:
            ...
            Acceptable values:
              ...
              RRENT_ON  (1): current auto range enabled
